					...
					<tr>
						<td align="center" valign="top" bgcolor="#d3be6c"
							...
							<div style="font-size: 48px; color:blue;">
								<b>A2B Digital Service</b>
							</div>
							
							<div style="font-size: 24px; color: #555100;">
								<br> We are glad to inform you that your loan has been submitted successfully. <br>
							</div>
							<div>
								...
								<br>"Please reach our support team to know further details or call: +91 9912905556" <br> <br>
